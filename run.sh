...
${WERCKER_STEP_ROOT}/hugo_${WERCKER_HUGO_THEME_CHECK_VERSION}_linux_amd64/hugo_${WERCKER_HUGO_THEME_CHECK_VERSION}_linux_amd64 -D -F -t ${WERCKER_HUGO_THEME_CHECK_NAME}
