...
${WERCKER_STEP_ROOT}/hugo_${WERCKER_HUGO_THEME_CHECK_VERSION}_linux_amd64/hugo_${WERCKER_HUGO_THEME_CHECK_VERSION}_linux_amd64 new site $WERCKER_STEP_ROOT/test		
...
${WERCKER_STEP_ROOT}/hugo_${WERCKER_HUGO_THEME_CHECK_VERSION}_linux_amd64/hugo_${WERCKER_HUGO_THEME_CHECK_VERSION}_linux_amd64 new post/test.markdown

${WERCKER_STEP_ROOT}/hugo_${WERCKER_HUGO_THEME_CHECK_VERSION}_linux_amd64/hugo_${WERCKER_HUGO_THEME_CHECK_VERSION}_linux_amd64 check -t ${WERCKER_HUGO_THEME_CHECK_NAME}
${WERCKER_STEP_ROOT}/hugo_${WERCKER_HUGO_THEME_CHECK_VERSION}_linux_amd64/hugo_${WERCKER_HUGO_THEME_CHECK_VERSION}_linux_amd64 build -D -F -t ${WERCKER_HUGO_THEME_CHECK_NAME}
